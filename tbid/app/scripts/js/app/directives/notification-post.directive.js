...
angular.module('tbidApp')
  .directive('notificationPost',['IMG_PATH','$rootScope','$timeout','postService','$filter','myProfileService','loginService','preLoginService','notificationService', function (IMG_PATH,$rootScope,$timeout,postService,$filter,myProfileService,loginService,preLoginService,notificationService) {
    ...
    return {
    	...
    	templateUrl: 'views/templates/notificationpost.html',
    	restrict: 'E',
    	controller : ["modalService", "createPostService","$scope","$rootScope","postService","notificationService",function (modalService,createPostService,$scope,$rootScope,postService,notificationService){
    		...
    		$scope.showFollowNotifySection = false;
		        ...
		        $scope.checkForDisplayPage = function(){
		        	if(notificationService.displaySection === 'displayPostSection'){
		        		$scope.openCommentsSection = false;
		        	}
		        	else if(notificationService.displaySection === 'displayPostCommentSection'){
		        		$scope.openCommentsSection = true;
		        		$scope.showFollowNotifySection=false;
		        	}
		        }
