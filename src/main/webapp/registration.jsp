...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin" enctype="multipart/form-data">
        ...
        <spring:bind path="avatarImgPath">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <input type="file" name="uploadAvtarImg" class="form-control"
                            placeholder="Avatar Image"></input>
                <form:errors path="avatarImgPath"></form:errors>
            </div>
        </spring:bind>
